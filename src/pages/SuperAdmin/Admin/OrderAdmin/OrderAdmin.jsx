            ...
            <div className="row g-0">
              ...
              <div className="col-auto mb-3 mb-md-0 me-auto">
                <div className="w-auto sw-md-30">
                  ...
                  <h1 className="mb-0 pb-0 display-4" id="title">Order Admin</h1>
                </div>
              </div>
              {/* <!-- Title End --> */}
              ...
              <div className="col-12 col-sm-6 col-md-auto d-flex align-items-end justify-content-end mb-2 mb-sm-0 order-sm-3">
                <a href="/orderadmin-add" className="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
